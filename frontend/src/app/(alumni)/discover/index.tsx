...
export default function StudentDiscoverScreen() {
  ...
  const filteredStudents = STUDENT_MOCKS.filter(student => {
            ...
            <Card className="mb-4">
              <View className="flex-row items-start mb-3">
                ...
                <View className="flex-1">
                  ...
                  <Typography variant="caption" color="muted">{item.department} • Class of {item.graduationYear}</Typography>
                  <Typography variant="caption" color="muted">{item.college}</Typography>
                </View>
              </View>
